...
import 'card_row_model.dart';
export 'card_row_model.dart';

class CardRowWidget extends StatefulWidget {
  const CardRowWidget({super.key});

  @override
  State<CardRowWidget> createState() => _CardRowWidgetState();
}

class _CardRowWidgetState extends State<CardRowWidget> {
  late CardRowModel _model;
