...
urlpatterns = [
    ...
    path('flashcard-stats/add', views.create_flashcard_stats, name='create_flashcard_stats'),
    path('flashcard-stats/<int:user_id>/update', views.update_flashcard_stats, name='update_flashcard_stats'),
